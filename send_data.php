...
$ch = curl_init();
$url="http://localhost/video/DPDP/recv_data.php";
...
$sql="Insert into gp_chargingurl (servicekey,channel,code,amount,tax,description,currency,chlreferenceCode,contentid, type,tittle,
      thumbnailUrl,successUrl,failureUrl,cancelUrl,notifyUrl,downloadUrl,validity,statuscode,gpreferenceCode,serverReferenceCode,
	  ...
	  '$cancelUrl','$notifyUrl','$downloadUrl','$validity','$statusCode','$referenceCode', '$serverReferenceCode',
